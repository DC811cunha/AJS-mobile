...
class SomosScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        primarySwatch: Colors.grey, // Define o tema principal do aplicativo com uma paleta de cinza
      ),
...
class SkateScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.grey[300], // Define a cor de fundo da AppBar como um tom claro de cinza
        elevation: 0, // Remove a sombra padrão da AppBar
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: Colors.black), // Define um ícone de seta para a esquerda (voltar) na cor preta
          onPressed: () {
            Navigator.pushNamed(context, '/home'); // Ao pressionar o botão, navega para a página principal (rota '/home')
          },
        ),
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.pushNamed(context, '/'); // Navega para a página de login ao pressionar o botão de perfil
            },
          ),
        ],
      ),
      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          padding: const EdgeInsets.all(16.0), // Define o espaçamento de 16 pixels ao redor do conteúdo da tela
          child: Column(
            ...
            children: [
              ...
              Center(
                child: ClipOval(
                  ...
                  child: Image.asset(
                    ...
                    width: 200, // Define a largura da imagem como 200 pixels (forma circular)
                    fit: BoxFit.cover, // Ajusta a imagem para cobrir o espaço, mantendo suas proporções
                  ),
                ),
              ),
              const SizedBox(height: 20), // Adiciona um espaçamento vertical de 20 pixels entre a imagem e o próximo widget
              ...
              const Text(
                ...
                style: TextStyle(
                  ...
                  height: 1.5, // Define a altura da linha do texto (espaçamento entre linhas) como 1.5 vezes o tamanho da fonte
                  color: Colors.black, // Define a cor do texto como preta
                ),
                textAlign: TextAlign.center, // Centraliza o texto horizontalmente na tela
              ),
            ],
          ),
        ),

  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: const Color.fromARGB(172, 189, 189,
          189), // Cor de fundo com um tom de cinza claro e transparência
      body: Center(
        ...
        child: SingleChildScrollView(
          ...
          padding: const EdgeInsets.symmetric(
              horizontal:
                  24.0), // Define o espaçamento horizontal (margem) nas laterais
          child: Column(
            ...
            children: [
                ...
                child: Center(
                  ...
                  child: ClipOval(
                    ...
                    child: Image.asset(
                      ...
                      height:
                          150, // Define a altura da imagem (igual à largura para ficar redonda)
              ...
              const TextField(
                obscureText:
                    true, // Define o campo como de texto secreto (isso deveria ser removido, pois e-mail não é secreto)
                decoration: InputDecoration(
              ...
              const TextField(
                ...
                decoration: InputDecoration(
                  labelText:
                      'CONFIRME SUA SENHA', // Texto de rótulo para o campo
                  border:
                      OutlineInputBorder(), // Define uma borda ao redor do campo
                  filled: true, // Preenche o fundo do campo
                  fillColor: Colors
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                HomeScreen())); // Navega para a tela inicial após o cadastro
                  },
